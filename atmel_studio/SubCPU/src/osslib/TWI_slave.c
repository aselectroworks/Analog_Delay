...
//#include "ioavr.h"				// For IAR assembler
#include <avr/io.h>					// For GCC
//#include "inavr.h"				// For IAR assembler
#include <avr/interrupt.h>			// For GCC
#include "TWI_slave.h"
...
application.
****************************************************************************/
//#pragma vector=TWI_vect				// For IAR assembler
//__interrupt void TWI_ISR( void )		// For IAR assembler
